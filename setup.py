...
setup(
    ...
    license="GPLV2+",
    # It does not make much sense to run pip install without installing also
    ...
    packages=['moncic', "moncic.build", "moncic.cli", "moncic.distro", "moncic.operations", "moncic.source", "moncic.utils"],
    scripts=['monci'],
    classifiers=[
